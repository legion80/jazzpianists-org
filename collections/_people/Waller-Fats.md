...
{%- capture intro -%}
{%- include u/youtube-player-embed.html youtube="PSNPpssruFY" aspect_ratio="5/4" -%}
{%- endcapture -%}
...
{% include u/people-article-image.html src="waller-organ.jpg" alt="Waller at the organ" %}
...
{% include u/music-player-embed.html pk=24 -%}

Waller stands as one of the supreme masters of stride piano. Building on the powerful left-hand techniques of {% include u/people-page.html person="James P. Johnson" %}, he combined rhythmic authority with a light, singing right hand and an unshakable sense of swing. His playing balanced virtuosity with clarity, elegance, and joy.

{% include u/music-player-embed.html pk=20 -%}
{%- endcapture -%}

{%- capture listen -%}

Although celebrated as a stride pianist, Waller regarded the pipe organ as his first love and spent much of his career trying to “tame” the instrument for jazz.
...
{% include u/music-player-embed.html pk=4 -%}

[^1]: Garvin Bushell (clarinet, alto saxophone, basson), Jabbo Smith (trumpet).
