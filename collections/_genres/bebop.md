...
![Bebop clarity]({{ site.timeline-image-directory }}bebop-double-time.jpg){: .music-example style="max-height: 6.8em" }
...
![Bebop dominant cadence alternatives]({{ site.timeline-image-directory }}bebop-dominant-tonic.jpg){: .music-example style="max-height: 7.5em" }
...
![Bebop locked hands]({{ site.timeline-image-directory }}bebop-locked-hands.jpg){: .music-example style="max-height: 7em" }
...
{% include u/music-player-embed.html pk=27 %}
