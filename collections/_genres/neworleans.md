...
{% include u/music-player-embed.html pk=16 %}

As New Orleans musicians relocated to Chicago as part of the [Great Migration](https://en.wikipedia.org/wiki/Great_Migration_(African_American)) during the 1910s and early 1920s, the music came with them. The jazz that came from New Orleans evolved further into New Orleans-style jazz, sometimes called Chicago jazz. The string bass replaced the tuba, and the guitar took over the banjo. Collective improvisation gave way to individual 
solos, sometimes very long ones.

{% include u/music-player-embed.html pk=15 %}
